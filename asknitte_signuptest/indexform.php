        ...
        <div class="left"> 
            ...
            <div class="formBox w3-container w3-content">
               ...
               <form id="signup" action = "signup2.php" method="post">
                ...
                <input type="email"        name="emailsign"  id="username" placeholder="Email address" style="text-transform: lowercase" required autocomplete="off"/>
            </div>
              ...
              <br>
                ...
                <input type="username"        name="usernamesign"  id="username" placeholder="username" style="text-transform: lowercase" minlength="5" required autocomplete="off"/>
            </div>
