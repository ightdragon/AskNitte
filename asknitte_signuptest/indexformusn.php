...
<!--
        ...
        <br>
            ...
            <div class="w3-center col-xs-1 p-3 mb-2  bg-light" align="center"><h2>OR</h2></div>
...
<div class="w3-container w3-teal w3-center w3-large col-xs-1" align="center">
        ...
        <div class="left"> 
             <h4 class="text-danger">Thats strange! USN already in use...</h4>
                    <h5>Try again...</h5>
            ...
            <div class="formBox w3-container w3-content">
               ...
               <form id="signup" action = "signup2.php" method="post">
                ...
                <input type="email"        name="emailsign"  id="username" placeholder="Email address" style="text-transform: lowercase" minlength="5" required autocomplete="off"/>
            </div>
